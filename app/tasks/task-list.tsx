...
export function TaskList({
  ...
  return (
    // Phones: one column, original order. Desktop: the "doing" pane (capture +
    // today) pins left while the structure (areas, inbox, archive) scrolls right.
    <div className="flex flex-col gap-8 lg:grid lg:grid-cols-12 lg:items-start lg:gap-8">
      <div className="space-y-8 lg:sticky lg:top-6 lg:col-span-7">
